...
export const handle = (async ({ event, resolve }) => {
  ...
  if(event.url.pathname.startsWith("/lampadas") || event.url.pathname.startsWith("/poco") || event.url.pathname.startsWith("/reservatorios") || event.url.pathname.startsWith("/saidas-de-agua")) {
